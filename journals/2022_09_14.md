	...
	- Hey so I just felt excitement about doing something.
		...
		- ## Hey everyone, I'm using a tool called LogSeq to manage my digital knowledge garden and releasing it as public domain #NewInternet #Experiment #Articles
			...
			- Getting back on track with this article.
				- A snapshot of everything we do on LogSeq is saved on your local computer every 60 seconds. Look at this storage system known as Git, in the community, as a sort of Akashic Records of your knowledge garden. It's a recording of its evolving process. You can see the whole process of change and organic evolution as if on a timeline. Why do I say this? Because sometimes we get hang up
