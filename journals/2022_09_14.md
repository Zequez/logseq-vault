	...
	- Hey so I just felt excitement about doing something.
		...
		- How can I motivate people into flowing power into me and supporting me?
			- Use information about contributions to prioritises access to workshops of limited capacity of participants. So highest contributors will be on he first cohort and so on. All workshops are free by default, but I give priority to my stakeholders, the people that are most committed to my evolution. Subscribing to me shows commitment.
				- There is no rigid expectation about the workshop access rules, it's a private process based on a number of variables that cannot be truly reflected JUST by a monetary value (for example, I might want to prioritize someone else just because I like them, even if they aren't on the contribution list), the rule is arbitrary and I can abide by flexible rules, it's an experimental Gameworld Design.
			-
				-
