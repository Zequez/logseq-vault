		...
		- ## Hey everyone, I'm using a tool called LogSeq to manage my digital knowledge garden and releasing it as public domain #NewInternet #Experiment #Articles
			...
			- Getting back on track with this article.
				- A snapshot of everything we do on LogSeq is saved on your local computer every 60 seconds. Look at this storage system known as Git, in the community, as a sort of Akashic Records of your knowledge garden. It's a recording of its evolving process. You can see the whole process of change and organic evolution as if on a timeline. Why do I say this? Because sometimes some of us, get hang up in the idea of making manual copies of content, and saving it as V1, V2, V3, etc. Well, this is not necessary, all the changes are saved on a timeline, every past state of the system can be called upon existence at any time.
					- This tendency showed up for me, when I was feeling anxiety about wether create a new PAGE to save/modify content, or change the content you created originally on the journal stream. I want to prioritize the Journal Stream because it's the most organic and way to use the computer; just one place where I write everything that comes to my mind and I can anything
